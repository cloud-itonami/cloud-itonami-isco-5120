(ns culinary.advisor
  "CulinaryAdvisor — proposes a culinary operation (cook-support step,
  plate a dish, operate near open flame or hot surfaces, handle
  allergen cross-contact) for a registered order ticket. The advisor
  ...
  PROPOSAL — it never writes to the store and has no notion of ticket
  provenance or open-flame/allergen risk; `culinary.governor` is the
  independent system that decides whether the proposal may proceed,
  per the itonami actor pattern.

  A proposal is a map:
    {:op :cook-support|:plate|:operate-near-open-flame|:handle-allergen-cross-contact
...
(def ^:private system-prompt
  "You are a culinary advisor. Given a cook-support or plating
